...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 250 · 🔀 2.8K · 📦 21 · 📋 880 - 1% open · ⏱️ 06.05.2024):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 360 · 🔀 1.9K · 📦 2.9K · 📋 2.4K - 6% open · ⏱️ 16.05.2024):
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 160 · 🔀 890 · 📋 350 - 8% open · ⏱️ 20.05.2024):
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 270 · 🔀 260 · 📥 51 · 📦 3 · 📋 9.8K - 3% open · ⏱️ 22.05.2024):

	```
	git clone https://github.com/microsoft/vscode-jupyter
	```
</details>
<details><summary><b><a href="https://github.com/iot-salzburg/gpu-jupyter">gpu-jupyter</a></b> (🥉16 ·  ⭐ 670) - Leverage the flexibility of Jupyterlab through the power of your.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/nteract/papermill) (👨‍💻 120 · 🔀 410 · 📦 6K · 📋 400 - 34% open · ⏱️ 26.04.2024):

	```
	git clone https://github.com/nteract/papermill
	```
- [PyPi](https://pypi.org/project/papermill) (📥 2.3M / month):
	```
...
- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 10 · 🔀 240 · 📥 99 · 📦 3.9K · 📋 75 - 61% open · ⏱️ 11.08.2023):
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 210 · 🔀 920 · 📦 3 · 📋 2K - 34% open · ⏱️ 08.02.2024):
...
<details><summary><b><a href="https://github.com/mwouts/itables">itables</a></b> (🥈23 ·  ⭐ 680) - Interactive Tables in Jupyter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mwouts/itables) (👨‍💻 6 · 🔀 51 · 📦 510 · 📋 140 - 14% open · ⏱️ 30.04.2024):

	```
	git clone https://github.com/mwouts/itables
	```
- [PyPi](https://pypi.org/project/itables) (📥 280K / month):
	```
	pip install itables
	```
</details>
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 470K · ⏱️ 05.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyvolume) (📥 850 / month):
	```
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 68 · 🔀 530 · 📥 53 · 📦 3.5K · 📋 360 - 41% open · ⏱️ 23.05.2024):

	```
	git clone https://github.com/evidentlyai/evidently
	```
</details>
<details><summary><b><a href="https://github.com/nicolaskruchten/jupyter_pivottablejs">pivottablejs</a></b> (🥉20 ·  ⭐ 680 · 💀) - Dragndrop Pivot Tables and Charts for Jupyter/IPython.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 32 · 🔀 60 · 📦 43 · 📋 990 - 32% open · ⏱️ 22.05.2024):
...
- [GitHub](https://github.com/medialab/ipysigma) (👨‍💻 6 · 🔀 15 · 📦 33 · 📋 210 - 27% open · ⏱️ 20.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 1.1K / month):
	```
	pip install ipysigma
	```
- [NPM](https://www.npmjs.com/package/ipysigma) (📥 430 / month):
	```
...
- [GitHub](https://github.com/finos/ipyregulartable) (👨‍💻 5 · 🔀 13 · 📦 13 · 📋 27 - 37% open · ⏱️ 05.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/ipyregulartable) (📥 270 / month):
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 21 · 📦 8 · ⏱️ 20.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipycanvas) (📥 36K / month):
	```
...
- [GitHub](https://github.com/ipyannotate/ipyannotate) (👨‍💻 4 · 🔀 13 · ⏱️ 20.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/ipyannotate) (📥 1.1K / month):
	```
...
- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · 🔀 1 · ⏱️ 10.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/tributary) (📥 290 / month):
	```
...
- [GitHub](https://github.com/DGothrek/ipyaggrid) (👨‍💻 2 · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/ipyaggrid) (📥 7.2K / month):
	```
	pip install ipyaggrid
	```
- [NPM](https://www.npmjs.com/package/ipyaggrid) (📥 880 / month):
	```
...
- [GitHub](https://github.com/GianniBalistreri/easyexplore) (👨‍💻 4 · 🔀 2 · 📦 2 · 📋 24 - 33% open · ⏱️ 01.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/easyexplore) (📥 210 / month):
	```
...
- [GitHub](https://github.com/ipython-contrib/jupyter_contrib_nbextensions) (👨‍💻 140 · 🔀 790 · 📦 20 · 📋 810 - 42% open · ⏱️ 21.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_contrib_nbextensions) (📥 540K / month):
	```
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 100 · 🔀 300 · 📥 360 · 📦 560 · 📋 910 - 26% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/jupyter/nbgrader
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 5.2K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 34 · 🔀 99 · 📥 280 · 📦 630 · 📋 91 - 48% open · ⏱️ 10.04.2024):

	```
	git clone https://github.com/jupyter-server/jupyter-resource-usage
	```
- [PyPi](https://pypi.org/project/jupyter-resource-usage) (📥 67K / month):
	```
...
- [GitHub](https://github.com/Jupyter-contrib/jupyter_nbextensions_configurator) (👨‍💻 24 · 🔀 120 · 📦 600 · 📋 100 - 64% open · ⏱️ 29.09.2023):

	```
	git clone https://github.com/jupyter-contrib/jupyter_nbextensions_configurator
	```
- [PyPi](https://pypi.org/project/jupyter_nbextensions_configurator) (📥 660K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 32 · 🔀 79 · 📦 790 · 📋 160 - 42% open · ⏱️ 07.05.2024):
...
- [GitHub](https://github.com/jupyter-incubator/contentmanagement) (👨‍💻 8 · 🔀 26 · 📦 16 · 📋 27 - 25% open · ⏱️ 11.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_cms) (📥 120 / month):
	```
	pip install jupyter_cms
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_cms) (📥 99K · ⏱️ 06.10.2023):
	```
...
- [GitHub](https://github.com/lspvic/jupyter_tensorboard) (👨‍💻 4 · 🔀 70 · 📋 69 - 57% open · ⏱️ 16.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-tensorboard) (📥 6.6K / month):
	```
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 55 · 🔀 270 · 📦 6.5K · 📋 150 - 70% open · ⏱️ 21.04.2023):

	```
	git clone https://github.com/catherinedevlin/ipython-sql
	```
- [PyPi](https://pypi.org/project/ipython-sql) (📥 220K / month):
	```
...
- [GitHub](https://github.com/jupyter-incubator/sparkmagic) (👨‍💻 64 · 🔀 410 · 📦 340 · 📋 430 - 30% open · ⏱️ 13.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/sparkmagic) (📥 49K / month):
	```
...
- [GitHub](https://github.com/rasbt/watermark) (👨‍💻 19 · 🔀 88 · 📦 2.3K · 📋 46 - 39% open · ⏱️ 02.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/watermark) (📥 31K / month):
	```
...
- [GitHub](https://github.com/csurfer/pyheatmagic) (👨‍💻 3 · 🔀 22 · 📦 45 · 📋 5 - 40% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/py-heat-magic) (📥 400 / month):
	```
...
- [GitHub](https://github.com/ShopRunner/jupyter-notify) (👨‍💻 11 · 🔀 38 · 📋 25 - 52% open · ⏱️ 27.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyternotify) (📥 790 / month):
	```
...
- [GitHub](https://github.com/takluyver/bash_kernel) (👨‍💻 20 · 🔀 120 · 📦 240 · 📋 110 - 11% open · ⏱️ 14.05.2024):
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 47 · 🔀 120 · 📥 180 · 📦 370 · 📋 190 - 9% open · ⏱️ 12.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 48K / month):
	```
...
- [GitHub](https://github.com/Calysto/octave_kernel) (👨‍💻 20 · 🔀 65 · 📥 190 · 📦 74 · 📋 180 - 18% open · ⏱️ 15.04.2024):
	...
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 8.9K / month):
	```
...
- [GitHub](https://github.com/SciRuby/iruby) (👨‍💻 47 · 🔀 24 · 📥 15 · 📦 230 · 📋 190 - 23% open · ⏱️ 12.05.2024):
...
- [GitHub](https://github.com/apache/incubator-toree) (👨‍💻 110 · 🔀 220 · ⏱️ 26.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/toree) (📥 5.2K / month):
	```
	pip install toree
	```
</details>
...
- [GitHub](https://github.com/almond-sh/almond) (👨‍💻 42 · 🔀 230 · 📥 2.4K · 📋 320 - 35% open · ⏱️ 17.05.2024):
...
- [GitHub](https://github.com/SpencerPark/IJava) (👨‍💻 4 · 🔀 190 · 📥 180K · 📋 150 - 58% open · ⏱️ 08.12.2019):
...
- [GitHub](https://github.com/IHaskell/IHaskell) (👨‍💻 120 · 🔀 250 · 📋 780 - 5% open · ⏱️ 22.05.2024):
...
- [GitHub](https://github.com/Cadair/jupyter_environment_kernels) (👨‍💻 8 · 🔀 17 · 📦 5 · 📋 30 - 23% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/environment_kernels) (📥 36K / month):
	```
	pip install environment_kernels
	```
</details>
<details><summary><b><a href="https://github.com/lfortran/lfortran">LFortran</a></b> (🥉16 ·  ⭐ 880) - Official mirror of https://gitlab.com/lfortran/lfortran. Please.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/WolframResearch/WolframLanguageForJupyter) (👨‍💻 7 · 🔀 120 · 📥 9.6K · 📋 110 - 31% open · ⏱️ 19.02.2022):
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 140 · 🔀 610 · 📦 14K · 📋 1.3K - 44% open · ⏱️ 11.03.2024):
...
- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 87 · 🔀 380 · 📦 7.4K · 📋 660 - 17% open · ⏱️ 05.05.2024):
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 70 · 🔀 490 · 📥 1.1K · 📦 11K · 📋 720 - 39% open · ⏱️ 23.05.2024):
...
- [GitHub](https://github.com/jupyter/nbdime) (👨‍💻 50 · 🔀 150 · 📥 130 · 📦 140 · 📋 340 - 22% open · ⏱️ 21.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/nbdime) (📥 470K / month):
	```
	pip install nbdime
	```
...
- [GitHub](https://github.com/jupyter/nbviewer) (👨‍💻 97 · 🔀 530 · 📦 20 · 📋 590 - 30% open · ⏱️ 27.01.2023):
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 46 · 🔀 42 · 📥 4.4K · 📦 20 · 📋 740 - 12% open · ⏱️ 21.05.2024):
...
- [GitHub](https://github.com/jupyterhub/binderhub) (👨‍💻 95 · 🔀 370 · 📦 9 · 📋 690 - 29% open · ⏱️ 14.05.2024):
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 80 · 🔀 150 · 📥 290 · 📦 290K · 📋 140 - 42% open · ⏱️ 04.04.2024):

	```
	git clone https://github.com/jupyter/nbformat
	```
- [PyPi](https://pypi.org/project/nbformat) (📥 27M / month):
	```
...
- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 38 · 🔀 52 · 📥 460 · 📦 170K · 📋 100 - 33% open · ⏱️ 13.03.2024):
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 51 · 🔀 470 · 📋 860 - 15% open · ⏱️ 18.05.2024):
...
- [PyPi](https://pypi.org/project/pixiedust) (📥 13K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pixiedust) (📥 51K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 130 · 🔀 270 · 📥 1.6K · 📋 380 - 46% open · ⏱️ 23.05.2024):
...
- [GitHub](https://github.com/twosigma/beakerx) (👨‍💻 44 · 🔀 380 · 📥 35 · 📋 4.5K - 7% open · ⏱️ 21.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/beakerx) (📥 2.8K / month):
	```
	pip install beakerx
	```
...
- [GitHub](https://github.com/QuantEcon/sphinxcontrib-jupyter) (👨‍💻 13 · 🔀 23 · 📦 38 · 📋 180 - 48% open · ⏱️ 18.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/sphinxcontrib-jupyter) (📥 2.1K / month):
	```
...
<details><summary><b><a href="https://github.com/tweag/jupyenv">JupyterWith</a></b> (🥉13 ·  ⭐ 610 · 💤) - declarative and reproducible Jupyter environments - powered by Nix. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/takluyver/jupyter_kernel_mgmt) (👨‍💻 74 · 🔀 8 · 📥 21 · 📋 25 - 44% open · ⏱️ 29.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-mgmt) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 1.3K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/latex) (📥 410 / month):
	```
...
- [GitHub](https://github.com/plotly/jupyterlab-dash) (👨‍💻 7 · 🔀 55 · 📦 690 · 📋 28 - 71% open · ⏱️ 19.05.2020):
...
- [PyPi](https://pypi.org/project/jupyterlab-dash) (📥 1.4K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-dash) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/quigleyj97/jupyterlab-spreadsheet) (👨‍💻 4 · 🔀 16 · 📦 6 · 📋 27 - 33% open · ⏱️ 18.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-spreadsheet) (📥 680 / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 29 · 📦 1.3K · 📋 25 - 32% open · ⏱️ 20.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 88 / month):
	```
	npm install @telamonian/theme-darcula
	```
</details>
<details><summary><b><a href="https://github.com/AllanChain/jupyterlab-theme-solarized-dark">jupyterlab-theme-solarized-dark</a></b> (🥈16 ·  ⭐ 94) - JupyterLab 2.x Solarized Dark extension. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/mohirio/jupyterlab-horizon-theme">Horizon Theme</a></b> (🥈15 ·  ⭐ 86) - VSCode Horizon Theme port for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/yeebc/jupyterlab-neon-theme) (👨‍💻 4 · 🔀 10 · 📦 4 · 📋 13 - 15% open · ⏱️ 28.08.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@yeebc/jupyterlab_neon_theme) (📥 260 / month):
	```
...
- [GitHub](https://github.com/jtpio/ipylab) (👨‍💻 7 · 🔀 13 · 📥 130 · 📦 120 · 📋 47 - 53% open · ⏱️ 09.10.2023):

	```
	git clone https://github.com/jtpio/ipylab
	```
- [PyPi](https://pypi.org/project/ipylab) (📥 140K / month):
	```
	pip install ipylab
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/spellchecker) (👨‍💻 6 · 🔀 19 · 📦 240 · 📋 59 - 32% open · ⏱️ 28.07.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@ijmbarr/jupyterlab_spellchecker) (📥 230 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-variableInspector) (👨‍💻 22 · 🔀 87 · 📥 80 · 📦 6 · 📋 170 - 24% open · ⏱️ 17.04.2024):

	```
	git clone https://github.com/lckr/jupyterlab-variableInspector
	```
- [NPM](https://www.npmjs.com/package/@lckr/jupyterlab_variableinspector) (📥 980 / month):
	```
	npm install @lckr/jupyterlab_variableinspector
	```
</details>
<details><summary><b><a href="https://github.com/ryantam626/jupyterlab_code_formatter">Code Formatter</a></b> (🥈18 ·  ⭐ 810 · 💤) - A universal code formatter for JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ryantam626/jupyterlab_code_formatter) (👨‍💻 42 · 🔀 52 · 📋 200 - 16% open · ⏱️ 18.06.2023):
...
<details><summary><b><a href="https://github.com/rapidsai/jupyterlab-nvdashboard">GPU Dashboards</a></b> (🥈18 ·  ⭐ 560) - A JupyterLab extension for displaying dashboards of GPU.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 21 · 🔀 71 · 📦 3 · 📋 79 - 40% open · ⏱️ 01.05.2024):

	```
	git clone https://github.com/rapidsai/jupyterlab-nvdashboard
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 6.9K / month):
	```
...
- [GitHub](https://github.com/jupyter-widgets/jupyterlab-sidecar) (👨‍💻 16 · 🔀 39 · 📦 7 · 📋 36 - 63% open · ⏱️ 30.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/sidecar) (📥 9.3K / month):
	```
	pip install sidecar
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-github) (📥 2.8K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/github) (📥 540 / month):
	```
...
<details><summary><b><a href="https://github.com/jwkvam/jupyterlab-vim">JupyterLab Vim</a></b> (🥈16 ·  ⭐ 970 · 💀) - Vim notebook cell bindings for JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/jpmorganchase/jupyter-fs">jupyter-fs</a></b> (🥈16 ·  ⭐ 180) - A filesystem-like contents manager for multiple backends in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/jpmorganchase/jupyter-fs) (👨‍💻 15 · 🔀 33 · 📦 8 · 📋 76 - 22% open · ⏱️ 23.05.2024):
...
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 11K / month):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 270 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-data-explorer) (👨‍💻 11 · 🔀 37 · 📦 14 · ⏱️ 08.08.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/dataregistry-extension) (📥 29 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 480 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/hdf5) (📥 56 / month):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 370 / month):
	...
	```
- [NPM](https://www.npmjs.com/package/@parente/jupyterlab-quickopen) (📥 86 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-shortcutui) (👨‍💻 9 · 🔀 14 · 📦 3 · ⏱️ 08.08.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/shortcutui) (📥 83 / month):
	```
...
<details><summary><b><a href="https://github.com/krassowski/jupyterlab-lsp">JupyterLab LSP</a></b> (🥉13 ·  ⭐ 96) - Coding assistance for JupyterLab (code navigation + hover.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/krassowski/jupyterlab-lsp) (👨‍💻 51 · 📦 26 · ⏱️ 04.02.2024):
	...
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 860 / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/nbcelltests) (👨‍💻 7 · 🔀 20 · 📦 3 · 📋 120 - 26% open · ⏱️ 07.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbcelltests) (📥 59 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 6 · 🔀 12 · 📥 29 · 📦 7 · 📋 13 - 15% open · ⏱️ 08.10.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 60 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 11 · 📥 99 · 📦 3 · 📋 9 - 11% open · ⏱️ 27.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-file) (📥 90 / month):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (👨‍💻 2 · 🔀 2 · 📦 1 · 📋 38 - 5% open · ⏱️ 06.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 170 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 120 · 🔀 340 · 📦 420 · 📋 300 - 14% open · ⏱️ 07.05.2024):
	...
	```
- [PyPi](https://pypi.org/project/oauthenticator) (📥 60K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 22 · 🔀 62 · 📦 80 · 📋 110 - 31% open · ⏱️ 07.05.2024):
...
- [GitHub](https://github.com/jupyterhub/firstuseauthenticator) (👨‍💻 12 · 🔀 29 · 📦 100 · 📋 26 - 34% open · ⏱️ 30.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-firstuseauthenticator) (📥 7.8K / month):
	```
...
- [GitHub](https://github.com/HewlettPackard/jupyterhub-samlauthenticator) (👨‍💻 7 · 🔀 22 · 📥 13 · 📋 32 - 53% open · ⏱️ 21.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-samlauthenticator) (📥 590 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nullauthenticator) (👨‍💻 7 · 🔀 10 · 📦 120 · ⏱️ 17.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/nullauthenticator) (📥 4.2K / month):
	```
...
- [GitHub](https://github.com/cwaldbieser/jhub_remote_user_authenticator) (👨‍💻 5 · 🔀 27 · 📋 20 - 45% open · ⏱️ 16.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/jhub_remote_user_authenticator) (📥 980 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 49 · 🔀 120 · 📦 34 · 📋 140 - 37% open · ⏱️ 07.05.2024):
	...
	```
- [PyPi](https://pypi.org/project/batchspawner) (📥 6.9K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/wrapspawner) (👨‍💻 19 · 🔀 56 · 📦 14 · 📋 33 - 51% open · ⏱️ 08.04.2024):
...
- [GitHub](https://github.com/uktrade/fargatespawner) (👨‍💻 3 · 🔀 21 · 📦 4 · 📋 11 - 54% open · ⏱️ 28.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/fargatespawner) (📥 480 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/yarnspawner) (👨‍💻 2 · 🔀 12 · 📋 11 - 63% open · ⏱️ 16.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-yarnspawner) (📥 87 / month):
	```
	pip install jupyterhub-yarnspawner
	```
- [Conda](https://anaconda.org/conda-forge/jupyterhub-yarnspawner) (📥 39K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 990 · 🔀 4.3K · 📥 320K · 📦 550K · 📋 7.3K - 22% open · ⏱️ 20.05.2024):

	```
	git clone https://github.com/ipython/ipython
	```
- [PyPi](https://pypi.org/project/ipython) (📥 46M / month):
	```
	pip install ipython
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 520 · 🔀 270 · 📥 2.9K · 📋 440 - 35% open · ⏱️ 09.05.2024):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 170 · 🔀 460 · 📦 11K · 📋 3.4K - 29% open · ⏱️ 23.05.2024):
