...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 650 · 🔀 4.5K · 📥 17K · 📦 270K · 📋 4.8K - 39% open · ⏱️ 29.03.2024):
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 360 · 🔀 1.9K · 📦 2.8K · 📋 2.4K - 6% open · ⏱️ 03.04.2024):
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 270 · 🔀 260 · 📦 3 · 📋 9.7K - 3% open · ⏱️ 03.04.2024):
...
- [Conda](https://anaconda.org/conda-forge/qgrid) (📥 400K · ⏱️ 16.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/qgrid) (📥 320 / month):
	```
	npm install qgrid
	```
</details>
<details><summary><b><a href="https://github.com/mwouts/itables">itables</a></b> (🥈23 ·  ⭐ 640) - Interactive Tables in Jupyter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 7 · 🔀 79 · 📥 88 · 📦 300 · 📋 270 - 40% open · ⏱️ 31.03.2024):
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 460K · ⏱️ 05.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/ipyvolume) (📥 800 / month):
	```
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 32 · 🔀 58 · 📦 41 · 📋 980 - 32% open · ⏱️ 03.04.2024):
...
<details><summary><b><a href="https://github.com/g2nb/igv-jupyter">igv.js widget</a></b> (🥉15 ·  ⭐ 150 · 💀) - Extension for Jupyter Notebook which integrates igv.js. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/vidartf/ipyscales) (👨‍💻 4 · 🔀 4 · 📦 58 · 📋 6 - 33% open · ⏱️ 01.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipyscales) (📥 23 / month):
	```
...
- [GitHub](https://github.com/GianniBalistreri/easyexplore) (👨‍💻 4 · 🔀 2 · 📦 2 · 📋 24 - 33% open · ⏱️ 01.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/easyexplore) (📥 60 / month):
	```
...
- [GitHub](https://github.com/ipython-contrib/jupyter_contrib_nbextensions) (👨‍💻 140 · 🔀 790 · 📦 20 · 📋 810 - 42% open · ⏱️ 21.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_contrib_nbextensions) (📥 510K / month):
	```
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 100 · 🔀 290 · 📥 340 · 📦 530 · 📋 900 - 26% open · ⏱️ 28.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 9.7K / month):
	```
...
- [GitHub](https://github.com/Jupyter-contrib/jupyter_nbextensions_configurator) (👨‍💻 24 · 🔀 120 · 📦 580 · 📋 100 - 64% open · ⏱️ 29.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_nbextensions_configurator) (📥 600K / month):
	```
...
- [Conda](https://anaconda.org/conda-forge/mamba_gator) (📥 40K · ⏱️ 16.06.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@mamba-org/gator-lab) (📥 28 / month):
	```
...
- [GitHub](https://github.com/jupyter-incubator/contentmanagement) (👨‍💻 8 · 🔀 26 · 📦 16 · 📋 27 - 25% open · ⏱️ 11.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_cms) (📥 73 / month):
	```
...
- [GitHub](https://github.com/googlecolab/jupyter_http_over_ws) (👨‍💻 3 · 🔀 51 · 📋 30 - 70% open · ⏱️ 30.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_http_over_ws) (📥 59K / month):
	```
...
- [GitHub](https://github.com/mozilla/jupyter-spark) (👨‍💻 12 · 🔀 30 · 📦 19 · 📋 27 - 48% open · ⏱️ 01.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-spark) (📥 910 / month):
	```
...
- [GitHub](https://github.com/lspvic/jupyter_tensorboard) (👨‍💻 4 · 🔀 70 · 📋 69 - 57% open · ⏱️ 16.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-tensorboard) (📥 6.8K / month):
	```
...
- [GitHub](https://github.com/ResidentMario/py_d3) (👨‍💻 4 · 🔀 40 · 📋 16 - 6% open · ⏱️ 20.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/py_d3) (📥 31 / month):
	```
	pip install py_d3
	```
</details>
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 47 · 🔀 120 · 📥 180 · 📦 360 · 📋 180 - 8% open · ⏱️ 12.03.2024):

	```
	git clone https://github.com/jupyter/kernel_gateway
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 38K / month):
	```
...
- [GitHub](https://github.com/Calysto/octave_kernel) (👨‍💻 20 · 🔀 64 · 📥 170 · 📦 72 · 📋 180 - 18% open · ⏱️ 18.12.2022):

	```
	git clone https://github.com/calysto/octave_kernel
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 9.2K / month):
	```
...
- [GitHub](https://github.com/jupyter-server/enterprise_gateway) (👨‍💻 120 · 🔀 210 · 📥 35K · 📋 570 - 12% open · ⏱️ 09.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_enterprise_gateway) (📥 3.2K / month):
	```
...
- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 270 · 🔀 530 · 📥 1.1K · 📦 260K · 📋 1.2K - 44% open · ⏱️ 04.04.2024):
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 68 · 🔀 480 · 📥 1.1K · 📦 11K · 📋 710 - 39% open · ⏱️ 03.04.2024):

	```
	git clone https://github.com/voila-dashboards/voila
	```
- [PyPi](https://pypi.org/project/voila) (📥 75K / month):
	```
	pip install voila
	```
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 44 · 🔀 43 · 📥 4.3K · 📦 20 · 📋 730 - 13% open · ⏱️ 02.04.2024):
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 65 · 📦 2 · 📋 92 - 57% open · ⏱️ 28.04.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@nteract/commuter) (📥 82 / month):
	```
...
- [GitHub](https://github.com/twosigma/beakerx) (👨‍💻 44 · 🔀 380 · 📥 35 · 📋 4.5K - 7% open · ⏱️ 21.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/beakerx) (📥 5.3K / month):
	```
	pip install beakerx
	```
...
- [GitHub](https://github.com/quigleyj97/jupyterlab-spreadsheet) (👨‍💻 4 · 🔀 16 · 📦 6 · 📋 27 - 33% open · ⏱️ 18.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-spreadsheet) (📥 790 / month):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 28 · 📦 1.3K · 📋 25 - 32% open · ⏱️ 20.07.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 87 / month):
	```
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 17 · 📦 8 · 📋 18 - 16% open · ⏱️ 16.12.2022):
	...
	```
- [NPM](https://www.npmjs.com/package/@oriolmirosa/jupyterlab_materialdarker) (📥 61 / month):
	```
...
- [GitHub](https://github.com/Rahlir/theme-gruvbox) (👨‍💻 3 · 🔀 9 · 📦 4 · ⏱️ 12.04.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@rahlir/theme-gruvbox) (📥 33 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-theme-toggle) (👨‍💻 2 · 🔀 3 · 📦 5 · 📋 5 - 20% open · ⏱️ 16.06.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-theme-toggle) (📥 430 / month):
	```
...
- [GitHub](https://github.com/kenshohara/theme-nord-extension) (🔀 1 · 📦 3 · 📋 5 - 20% open · ⏱️ 20.09.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@kenshohara/theme-nord-extension) (📥 11 / month):
	```
...
- [GitHub](https://github.com/finos/jupyterlab_templates) (👨‍💻 21 · 🔀 63 · 📦 8 · 📋 92 - 9% open · ⏱️ 27.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 22K / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/spellchecker) (👨‍💻 6 · 🔀 19 · 📦 230 · 📋 57 - 31% open · ⏱️ 28.07.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@ijmbarr/jupyterlab_spellchecker) (📥 270 / month):
	```
...
- [GitHub](https://github.com/krassowski/jupyterlab-go-to-definition) (👨‍💻 2 · 🔀 9 · 📦 17 · 📋 23 - 43% open · ⏱️ 28.07.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@krassowski/jupyterlab_go_to_definition) (📥 290 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-data-explorer) (👨‍💻 10 · 🔀 37 · 📦 14 · ⏱️ 08.08.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/dataregistry-extension) (📥 21 / month):
	```
...
- [GitHub](https://github.com/aquirdTurtle/Collapsible_Headings) (👨‍💻 6 · 🔀 8 · 📋 33 - 33% open · ⏱️ 22.05.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/@aquirdturtle/collapsible_headings) (📥 310 / month):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-commenting) (👨‍💻 10 · 🔀 23 · 📦 3 · 📋 35 - 71% open · ⏱️ 01.05.2020):
	...
	```
- [NPM](https://www.npmjs.com/package/@jupyterlab/commenting-extension) (📥 5 / month):
	```
...
- [GitHub](https://github.com/jpmorganchase/nbcelltests) (👨‍💻 7 · 🔀 20 · 📦 3 · 📋 120 - 26% open · ⏱️ 07.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbcelltests) (📥 16 / month):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 6 · 🔀 12 · 📥 29 · 📦 7 · 📋 13 - 15% open · ⏱️ 08.10.2023):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 57 / month):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 11 · 📥 99 · 📦 3 · 📋 9 - 11% open · ⏱️ 27.08.2021):
	...
	```
- [NPM](https://www.npmjs.com/package/jupyterlab-python-file) (📥 88 / month):
	```
...
- [GitHub](https://github.com/ReviewNB/jupyterlab-gitplus) (👨‍💻 2 · 🔀 8 · 📦 3 · 📋 11 - 18% open · ⏱️ 28.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_gitplus) (📥 20 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 120 · 🔀 340 · 📦 410 · 📋 290 - 15% open · ⏱️ 02.04.2024):

	```
	git clone https://github.com/jupyterhub/oauthenticator
	```
- [PyPi](https://pypi.org/project/oauthenticator) (📥 46K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 18 · 🔀 49 · 📦 110 · 📋 50 - 6% open · ⏱️ 02.04.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-ltiauthenticator) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/jupyterhub/nullauthenticator) (👨‍💻 7 · 🔀 10 · 📦 120 · ⏱️ 17.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/nullauthenticator) (📥 5.5K / month):
	```
...
- [GitHub](https://github.com/thedataincubator/jupyterhub-hashauthenticator) (👨‍💻 3 · 🔀 3 · ⏱️ 04.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-hashauthenticator) (📥 20 / month):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 84 · 🔀 280 · 📦 160 · 📋 360 - 20% open · ⏱️ 02.04.2024):
...
- [GitHub](https://github.com/jupyterhub/wrapspawner) (👨‍💻 19 · 🔀 57 · 📦 11 · 📋 33 - 51% open · ⏱️ 04.04.2024):
